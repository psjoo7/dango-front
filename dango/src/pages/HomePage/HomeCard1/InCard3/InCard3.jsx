...
const InCard3 = () => {
  ...
  return (
    ...
    >
      ...
      {isHovered ? (
        <img
          src={`${process.env.PUBLIC_URL}/assets/images/HomePage/HomePageCharacterDango3_w.svg`}
          className={styles.characterSVG}
        />
      ) : (
        <img
          src={`${process.env.PUBLIC_URL}/assets/images/HomePage/HomePageCharacter3_w.svg`}
          className={styles.characterSVG}
        />
      )}
