import styles from "./GrammarTestPageForm.module.css";
import WordCard1 from "../WordTestPageForm/WordTestCard1/WordTestCard1";
import WordTestCard2 from "../WordTestPageForm/WordTestCard2/WordTestCard2";
...
const GrammarTestPageForm = () => {
  ...
  useEffect(() => {
    ...
    const storedIndex =
      parseInt(localStorage.getItem("currentGrammerIndex")) || 0;
  ...
  const handleKnowClick = () => {
    ...
    if (currentIndex + 1 < words.length) {
      ...
      localStorage.setItem("currentGrammerIndex", newIndex);
    } else {
      // 모든 단어를 다 학습했을 때
...
export default GrammarTestPageForm;
