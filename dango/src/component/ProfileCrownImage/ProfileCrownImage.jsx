...
import styles from "./ProfileCrownImage.module.css";

const ProfileCrownImage = ({
    ...
    const imageSrc = `${process.env.PUBLIC_URL}/assets/images/ProfileCrown/Profile${propImageCode}.svg`;  // 파일명만 변경 가능
...
export default ProfileCrownImage;
